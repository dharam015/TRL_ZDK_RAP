"! This class is used to fill travel data into the table zrap100_atravzdk
CLASS zcl_rap100_gen_data_zdk DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_ZDK IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'ZDK',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravzdk.
*    DELETE FROM zrap100_dtravzdk.

    "insert travel demo data
    INSERT zrap100_atravzdk  FROM (
        SELECT
